    ...
    async function loadData() {
      try {
        ...
        if (!projectResponse.ok || !projectData.ok) {
          setMessage(projectData.message || "Erro ao carregar projeto.");
          return;
        }
  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-600">Atualize as informações do projeto.</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-6">
        <section className="rounded-lg border border-gray-200 bg-white">
          <div className="border-b border-gray-200 px-5 py-4">
            <h2 className="font-semibold text-gray-900">Dados do projeto</h2>
          </div>
          ...
          <div className="grid gap-4 p-5 md:grid-cols-2">
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-gray-700">Orçamento</label>
        ...
        <div className="flex justify-end gap-3">
          <button
            type="button"
            onClick={() => router.push(`/admin/projetos/${id}`)}

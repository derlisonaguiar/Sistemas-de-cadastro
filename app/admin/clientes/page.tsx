    ...
    <div className="max-w-6xl">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">Gerencie os clientes da organização.</p>
        </div>
      ...
      <div className="overflow-hidden rounded-lg border border-gray-200 bg-white">
        {loading ? (
          <div className="p-6 text-sm text-gray-600">Carregando clientes...</div>
            ...
            <table className="w-full text-left text-sm">
              <thead className="border-b border-gray-200 bg-gray-50">
                <tr>
                  ...
                  <th className="px-5 py-3 font-medium text-gray-600">CPF/CNPJ</th>
                  <th className="px-5 py-3 font-medium text-gray-600">Contato</th>
                ...
                {filteredClients.map((client) => (
                  <tr key={client.id}>
                    <td className="px-5 py-4">
                      ...
                      <p className="text-xs text-gray-500">{client.companyName || "Pessoa física"}</p>
                    </td>

                    <td className="px-5 py-4 text-gray-700">{client.cpfCnpj || "—"}</td>

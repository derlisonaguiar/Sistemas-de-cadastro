...
export default function ClientePage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const [clientResponse, organizationResponse] = await Promise.all([
  ...
  if (!client) {
    return (
      <div className="rounded-lg border border-gray-200 bg-white p-6">
        <h1 className="text-xl font-semibold text-gray-900">Cliente não encontrado</h1>
    ...
    <div className="max-w-6xl">
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        <div>
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span
              className={`rounded-full px-2.5 py-1 text-xs font-medium ${
                client.active ? "bg-green-50 text-green-700" : "bg-gray-100 text-gray-600"
              }`}
            >
          ...
          <p className="mt-1 text-sm text-gray-600">Dados e informações do cliente.</p>
        </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <section className="rounded-lg border border-gray-200 bg-white">
          ...
          <div className="grid gap-5 p-5 sm:grid-cols-2">
            ...
            <div>
              <p className="text-xs font-medium uppercase text-gray-500">Razão social / Empresa</p>
            ...
            <div>
              <p className="text-xs font-medium uppercase text-gray-500">Pessoa de contato</p>
              <p className="mt-1 text-sm text-gray-900">{client.contactName || "—"}</p>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-lg border border-gray-200 bg-white">
          ...
          <div className="grid gap-5 p-5 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              <p className="text-xs font-medium uppercase text-gray-500">Endereço</p>

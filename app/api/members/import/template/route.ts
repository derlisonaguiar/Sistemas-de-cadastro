...
export async function GET(request: Request) {
  ...
  XLSX.utils.book_append_sheet(
    ...
    XLSX.utils.aoa_to_sheet([
      ["Instruções"],
      ["Preencha a aba Membros. Nome é obrigatório; Status usa Ativo, Inativo, Afastado, Egresso ou Pós-Jr."],
      ["Diretoria e Cargo devem existir previamente na organização."],
    ]),
    "Instruções"
  );

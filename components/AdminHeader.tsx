...
export default function AdminHeader({
  ...
  return (
    <header className="admin-header">
      <div>
        <p className="text-sm font-semibold tracking-tight text-gray-900">Painel Administrativo</p>
      ...
      <div className="admin-header-user flex items-center gap-3">
        <div className="text-right">
          <p className="text-sm font-medium text-gray-900">{isGlobalAdministration ? "Superadmin" : "Administrador"}</p>
          <p className="text-xs text-gray-500">{isGlobalAdministration ? "Acesso global" : "Acesso administrativo"}</p>
        </div>
